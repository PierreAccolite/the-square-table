...
function handleSerialLine(line){
  ...
  if(line.startsWith("GAME,")){
    const n=Number(line.substring(5));
    if(Number.isInteger(n) && n>=0 && n<games.length) selectGame(n);
    return;
  }
